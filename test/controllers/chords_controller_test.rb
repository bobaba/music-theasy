...
class ChordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chord" do
    assert_difference('Chord.count') do
      post chords_url, params: { chord: { chord_name: @chord.chord_name, formula: @chord.formula } }
    end
  ...
  test "should update chord" do
    patch chord_url(@chord), params: { chord: { chord_name: @chord.chord_name, formula: @chord.formula } }
